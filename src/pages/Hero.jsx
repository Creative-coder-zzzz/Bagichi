        ...
        {slides.map((slide) => (
          <SwiperSlide key={slide.id} className="relative">
            ...
            <div className="absolute inset-0 flex flex-col justify-center px-6 md:px-20 text-left space-y-3 md:space-y-4">
              <h2 className="text-[#FFD700] text-3xl md:text-5xl font-semibold md:font-bold leading-snug drop-shadow-lg">
                {slide.text}
              </h2>

              <p className="text-white text-4xl md:text-6xl font-bold md:font-extrabold leading-tight drop-shadow-lg">
                {slide.description}
              </p>

              <p className="text-white/90 text-md md:text-lg max-w-lg leading-relaxed drop-shadow-md">
                {slide.para}
              </p>
